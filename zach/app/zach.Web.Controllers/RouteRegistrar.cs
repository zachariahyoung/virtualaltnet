...
namespace zach.Web.Controllers
{
    public class RouteRegistrar
    {
        public static void RegisterRoutesTo(RouteCollection routes)
        {
            ...
            //routes.CreateArea("Organization/Department", "zach.Web.Controllers.Organization.Department",
            ...
            //);
            //routes.CreateArea("Organization", "zach.Web.Controllers.Organization",
            ...
            routes.CreateArea("Root", "zach.Web.Controllers",
