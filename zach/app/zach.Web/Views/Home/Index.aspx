...
<%@ Import Namespace="zach.Web.Controllers" %>
    ...
    <p>
        ...
        <ol>
            <li>
                ...
                within zach.Web/NHibernate.config</span>
	        </li>
            <li>
                Optionally, modify the Fluent NHibernate preferences within zach.Data.NHibernateMaps.GetConventions() 
            ...
            <li>
                Open zach.Tests.dll via NUnit and make sure all the tests are turning green.
	        </li>
            <li>
                ...
                zach.Web.Controllers.RouteRegistrar.RegisterRoutesTo() after the scaffolding generator has completed.)
	        </li>
        </ol>
    </p>
    <p>
