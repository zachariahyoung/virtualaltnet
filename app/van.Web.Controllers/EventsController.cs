...
namespace van.Web.Controllers
{
    ...
    {
        public EventsController(IRepository<Event> upcomingEventRepository) {
        ...
        public ActionResult Index() {
            IList<Event> upcomingEvents = upcomingEventRepository.GetAll();
            return View(upcomingEvents);
        }

        [Transaction]
        public ActionResult Show(int id) {
            Event upcomingEvent = upcomingEventRepository.Get(id);
        ...
        public ActionResult Create(Event upcomingEvent) {
        ...
        [Transaction]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Edit(Event upcomingEvent) {
            Event upcomingEventToUpdate = upcomingEventRepository.Get(upcomingEvent.Id);
        ...
        private void TransferFormValuesTo(Event upcomingEventToUpdate, Event upcomingEventFromForm) {
        ...
        public ActionResult Delete(int id) {
            ...
            Event upcomingEventToDelete = upcomingEventRepository.Get(id);
        ...
        private readonly IRepository<Event> upcomingEventRepository;
    }
}
